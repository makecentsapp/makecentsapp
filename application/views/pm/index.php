	...
	<div class="container pull-up">
	    <div class="row m-b-90">
	        <div class="col-lg-4 col-md-6">
	            <a href="<?php echo base_url ('PM/personalForm'); ?>" class="card shadow-lg guide-item m-b-30">
	            ...
	            <a href="<?php echo base_url ('PM/incomeForm'); ?>" class="card shadow-lg guide-item m-b-30">
	        ...
	        <div class="col-lg-4 col-md-6">
	            <a href="<?php echo base_url ('PM/assetsForm'); ?>" class="card shadow-lg guide-item m-b-30">
