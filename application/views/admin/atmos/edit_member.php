<div class="bg-dark">
    <ol class="breadcrumb my-0 py-0 text-primary bg-dark">
        ...
        <li class="breadcrumb-item active"><?php echo lang("ctn_22") ?></li>
    </ol>
</div>
<div class="bg-dark">
        ...
        <div class="row">
            <div class="col-12 text-white p-t-20 p-b-90">
                <h4>
                    ...
                    <?php echo lang("ctn_22") ?>
                </h4>
                <p><?php echo lang("ctn_23_1") ?></p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="col-12">
            <div class="card m-b-30">
            	<div class="float-right m-2">
                    <a href="<?php echo site_url("admin/member_user_groups/" . $member->ID) ?>" class="btn btn-info btn-sm">User Groups</a>
                </div>
                <div class="card-body">
		            <?php echo form_open_multipart(site_url("admin/edit_member_pro/" . $member->ID), array("class" => "form-horizontal")) ?>
		            <div class="row mb-3">
		                <label for="email-in" class="col-md-3 col-form-label"><?php echo lang("ctn_24") ?></label>
		                <div class="col-md-9">
		                    <input type="email" class="form-control" id="email-in" name="email" value="<?php echo $member->email ?>">
		                </div>
		            </div>
		            <div class="row mb-3">
		                <label for="username-in" class="col-md-3 col-form-label"><?php echo lang("ctn_25") ?></label>
		                <div class="col-md-9">
		            ...
		            <div class="row mb-3">
		                <label for="inputEmail3" class="col-sm-3 col-form-label"><?php echo lang("ctn_26") ?></label>
		                <div class="col-sm-9">
		            ...
		            <div class="row mb-3">
		                <label for="password-in" class="col-md-3 col-form-label"><?php echo lang("ctn_27") ?></label>
		                <div class="col-md-9">
		                    <input type="password" class="form-control" id="password-in" name="password" value="">
		                    <span class="form-text text-muted small"><?php echo lang("ctn_28") ?></span>
		                </div>
		            </div>

		            <div class="row mb-3">
		                <label for="name-in" class="col-md-3 col-form-label"><?php echo lang("ctn_29") ?></label>
		                <div class="col-md-9">
		                    <input type="text" class="form-control" id="name-in" name="first_name" value="<?php echo $member->first_name ?>">
		                </div>
		            </div>
		            <div class="row mb-3">
		                <label for="name-in" class="col-md-3 col-form-label"><?php echo lang("ctn_30") ?></label>
		                <div class="col-md-9">
		                    <input type="text" class="form-control" id="name-in" name="last_name" value="<?php echo $member->last_name ?>">
		                </div>
		            </div>
		            <div class="row mb-3">
		                <label for="name-in" class="col-md-3 col-form-label"><?php echo lang("ctn_350") ?></label>
		                <div class="col-md-9">
		                    <input type="text" class="form-control" id="name-in" name="credits" value="<?php echo $member->points ?>">
		                </div>
		            </div>
		            <div class="row mb-3">
		                <label for="inputEmail3" class="col-sm-3 col-form-label"><?php echo lang("ctn_31") ?></label>
		                <div class="col-sm-9">
		            ...
		            <div class="row mb-3">
		                <label for="inputEmail3" class="col-sm-3 col-form-label"><?php echo lang("ctn_391") ?></label>
		                <div class="col-sm-9">
		                    <input type="text" name="address_1" class="form-control" value="<?php echo $member->address_1 ?>">
		                </div>
		            </div>
		            <div class="row mb-3">
		                <label for="inputEmail3" class="col-sm-3 col-form-label"><?php echo lang("ctn_392") ?></label>
		                <div class="col-sm-9">
		                    <input type="text" name="address_2" class="form-control" value="<?php echo $member->address_2 ?>">
		                </div>
		            </div>
		            <div class="row mb-3">
		                <label for="inputEmail3" class="col-sm-3 col-form-label"><?php echo lang("ctn_393") ?></label>
		                <div class="col-sm-9">
		                    <input type="text" name="city" class="form-control" value="<?php echo $member->city ?>">
		                </div>
		            </div>
		            <div class="row mb-3">
		                <label for="inputEmail3" class="col-sm-3 col-form-label"><?php echo lang("ctn_394") ?></label>
		                <div class="col-sm-9">
		                    <input type="text" name="state" class="form-control" value="<?php echo $member->state ?>">
		                </div>
		            </div>
		            <div class="row mb-3">
		                <label for="inputEmail3" class="col-sm-3 col-form-label"><?php echo lang("ctn_395") ?></label>
		                <div class="col-sm-9">
		                    <input type="text" name="zipcode" class="form-control" value="<?php echo $member->zipcode ?>">
		                </div>
		            </div>
		            <div class="row mb-3">
		                <label for="inputEmail3" class="col-sm-3 col-form-label"><?php echo lang("ctn_396") ?></label>
		                <div class="col-sm-9">
		            ...
		            <div class="row mb-3">
		                <label for="name-in" class="col-md-3 col-form-label"><?php echo lang("ctn_36") ?></label>
		                <div class="col-md-9">
		            ...
		            <div class="row mb-3">
		                <label for="name-in" class="col-md-3 col-form-label"><?php echo lang("ctn_40") ?></label>
		                <div class="col-md-9">
		                    <?php foreach($user_groups->result() as $r) : ?>
		                        <a class="badge badge-info mx-1" href="<?php echo site_url("admin/view_group/" . $r->groupid) ?>"><?php echo $r->name ?></a>
		                    <?php endforeach; ?>
		                </div>
		            </div>
		            <div class="row mb-3">
		                <label for="name-in" class="col-md-3 col-form-label"><?php echo lang("ctn_331") ?></label>
		                <div class="col-md-9">
		                    ...
		                    <div class="col-md-9">
		                        ...
		                        <?php elseif($r->type == 2) : ?>
		                            ...
		                            <?php if(count($options) > 0) : ?>
		                                ...
		                                <div class="row mb-3"><input type="checkbox" name="cf_cb_<?php echo $r->ID ?>_<?php echo $k ?>" value="1" <?php if(in_array($v,$values)) echo "checked" ?>> <?php echo $v ?></div>
		                                <?php endforeach; ?>
		                            <?php endif; ?>
		                        <?php elseif($r->type == 3) : ?>
		                            <?php $options = explode(",", $r->options); ?>
		                            ...
		                            <?php if(count($options) > 0) : ?>
		                                <?php foreach($options as $k=>$v) : ?>
		                                <div class="row mb-3"><input type="radio" name="cf_radio_<?php echo $r->ID ?>" value="<?php echo $k ?>" <?php if($r->value == $v) echo "checked" ?>> <?php echo $v ?></div>
		                                <?php endforeach; ?>
		                            <?php endif; ?>
		                        <?php elseif($r->type == 4) : ?>
		                            <?php $options = explode(",", $r->options); ?>
