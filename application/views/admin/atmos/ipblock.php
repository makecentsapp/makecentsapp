<div class="white-area-content">
  ...
  <table class="table table-bordered tbl">
    ...
    <?php foreach($ipblock->result() as $r) : ?>
        <tr><td><?php echo $r->IP ?></td><td><?php echo $r->reason ?></td><td><?php echo date($this->settings->info->date_format, $r->timestamp) ?></td><td><a href="<?php echo site_url("admin/delete_ipblock/" . $r->ID) ?>" class="btn btn-danger btn-xs" title="<?php echo lang("ctn_57") ?>"><span class="fas fa-trash"></span></a></td></tr>
    <?php endforeach; ?>
</table>
