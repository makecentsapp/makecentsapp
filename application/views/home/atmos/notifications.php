                    ...
                    <div class="form-inline input-group input-group-sm">
                        ...
                        <div class="input-group-append">
                            ...
                            <ul class="dropdown-menu small-text" style="min-width: 90px !important; left: -90px;">
                                ...
                                <li><a class="text-muted dropdown-item" href="#" onclick="change_search(3)"><span class="fas fa-check no-display" id="message-exact"></span> <?php echo lang("ctn_412") ?></a></li>
                            </ul>
                        </div>
                    ...
                    <div class="table-responsive">
                        <div id="table_wrapper01" class="datatables_wrapper dt-bootstrap4">
                            <div class="row mx-auto">
                                <div class="col-sm-12">
                                    <table id="noti-table" class="table datatable table-striped table-hover table-bordered">
                                        <thead>
