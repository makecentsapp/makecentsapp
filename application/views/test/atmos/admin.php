    ...
    <div class="container  m-b-30">
        <div class="row">
            <div class="col-12 text-white p-t-20 p-b-90">
                ...
                <p class="opacity-75">This is an example of a page in which only users with Admin status can access. You can set a User's status in the Admin Panel area.</p>
            </div>
        </div>
    </div>
</div>
<div class="container pull-up">
    <div class="row">
        <div class="card m-b-30">
            ...
            <div class="card-body">
                <p class="card-text">Some quick example text to build on the card title and summarize the bulk
