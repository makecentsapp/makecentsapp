<div class="bg-dark py-0 my-0">
    <ol class="breadcrumb my-0 py-0 text-primary bg-dark">
        ...
        <li class="breadcrumb-item active">Test Full Page</li>
    </ol>
</div>
    ...
    <div class="container  m-b-30">
        <div class="row">
            <div class="col-12 text-white p-t-20 p-b-90">
                ...
                <p class="opacity-75">This is an example of a full page. Updated for BootStrap 4 by the MakeCents team. This page is not restricted by controller, just by nav bar link.</p>
                <p>The base CSS of this site use's <a class="text-primary" href="http://getbootstrap.com/">Bootstrap 4</a>. Below is a copy of Bootswatches example page <a class="text-primary" href="https://bootswatch.com/default/">Found Here</a></p>
                <p>This sites style has been heavily customized, but still technically bootstrap 4. You can see the results of the vanilla bootstrap below.
            </div>
        </div>
    </div>
</div>
<div class="container col-sm-12 pull-up">
    <div class="row">
        <div class="jumbotron">
            <!-- Navbar
                  ================================================== -->
                        ...
                        <form class="bs-component">
                          <div class="form-group">
                            <fieldset disabled="">
                              ...
                              <input class="form-control" id="disabledInput" type="text" placeholder="Disabled input here..." disabled="" style="background-image: url(&quot;data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR4nGP6zwAAAgcBApocMXEAAAAASUVORK5CYII=&quot;);">
                            </fieldset>
                          </div>
                  ...
                  <div id="source-modal" class="modal fade" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <pre contenteditable="">&lt;div class="modal"&gt;
              &lt;div class="modal-dialog" role="document"&gt;
                &lt;div class="modal-content"&gt;
                  &lt;div class="modal-header"&gt;
                    &lt;h5 class="modal-title"&gt;Modal title&lt;/h5&gt;
